<x-layouts.messaging-public title="Opt-Out Link Expired">
            ...
            <div class="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
                <div class="px-8 py-10 sm:px-10">
                    ...
                    <h1 class="mt-6 text-3xl font-bold tracking-tight text-slate-950 sm:text-4xl">
                        This opt-out link is no longer valid.
                    </h1>

                    <p class="mt-5 text-base leading-7 text-slate-600">
                        For your protection, opt-out links expire after a set period of time.
                    </p>

                    <p class="mt-4 text-base leading-7 text-slate-600">
                        Please use the opt-out link from the most recent email you received.
                    </p>
