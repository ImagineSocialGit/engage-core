...
| Reporting foundation | Reporting through public transport/classification | In progress | Contract, schema, observation ingestion, generic same-origin browser transport, and conservative traffic classification are complete. Next: Webinar behavioral funnel, then authoritative producer projections before Reporting UI. |
