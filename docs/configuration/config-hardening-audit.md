...
Use this document as historical and architectural context. Use `config-contracts.md` for the current contract model and `roadmap.md` for remaining implementation work.
