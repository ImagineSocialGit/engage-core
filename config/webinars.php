    ...
    'schedule_profiles' => [
        ...
        'full_10_day' => [
            ...
            'items' => [
                ...
                ['key' => 'sms_reminder_live', 'label' => 'SMS live reminder', 'context_key' => 'reminders', 'channel' => 'sms', 'purpose' => 'transactional', 'scope' => 'webinar', 'surface' => 'webinar_registrations', 'message_type' => 'reminder', 'dispatch_key' => 'registration_created', 'source_config_path' => 'messaging.sms.transactional.webinar.reminders.5', 'timing' => 'scheduled', 'schedule' => ['type' => 'anchored', 'minutes' => 0], 'sort_order' => 250],

                ['key' => 'email_waitlist_alert', 'label' => 'Email waitlist alert', 'context_key' => 'waitlist', 'channel' => 'email', 'purpose' => 'marketing', 'scope' => 'webinar_waitlist', 'surface' => 'webinar_waitlists', 'message_type' => 'alert', 'dispatch_key' => 'webinar_added', 'source_config_path' => 'messaging.email.marketing.webinar_waitlist.alerts.0', 'timing' => 'immediate', 'sort_order' => 300],
                ['key' => 'sms_waitlist_alert', 'label' => 'SMS waitlist alert', 'context_key' => 'waitlist', 'channel' => 'sms', 'purpose' => 'marketing', 'scope' => 'webinar_waitlist', 'surface' => 'webinar_waitlists', 'message_type' => 'alert', 'dispatch_key' => 'webinar_added', 'source_config_path' => 'messaging.sms.marketing.webinar_waitlist.alerts.0', 'timing' => 'immediate', 'sort_order' => 310],

                ['key' => 'email_post_attended', 'label' => 'Email attended replay follow-up', 'context_key' => 'post_attended', 'channel' => 'email', 'purpose' => 'transactional', 'scope' => 'webinar', 'surface' => 'webinar_registrations', 'message_type' => 'post_attended', 'dispatch_key' => 'webinar_ended', 'source_config_path' => 'messaging.email.transactional.webinar.post_attended.0', 'timing' => 'immediate', 'sort_order' => 400],
                ['key' => 'sms_post_attended', 'label' => 'SMS attended replay follow-up', 'context_key' => 'post_attended', 'channel' => 'sms', 'purpose' => 'transactional', 'scope' => 'webinar', 'surface' => 'webinar_registrations', 'message_type' => 'post_attended', 'dispatch_key' => 'webinar_ended', 'source_config_path' => 'messaging.sms.transactional.webinar.post_attended.0', 'timing' => 'immediate', 'sort_order' => 410],
                ['key' => 'email_post_missed', 'label' => 'Email missed replay follow-up', 'context_key' => 'post_missed', 'channel' => 'email', 'purpose' => 'transactional', 'scope' => 'webinar', 'surface' => 'webinar_registrations', 'message_type' => 'post_missed', 'dispatch_key' => 'webinar_ended', 'source_config_path' => 'messaging.email.transactional.webinar.post_missed.0', 'timing' => 'immediate', 'sort_order' => 420],
                ['key' => 'sms_post_missed', 'label' => 'SMS missed replay follow-up', 'context_key' => 'post_missed', 'channel' => 'sms', 'purpose' => 'transactional', 'scope' => 'webinar', 'surface' => 'webinar_registrations', 'message_type' => 'post_missed', 'dispatch_key' => 'webinar_ended', 'source_config_path' => 'messaging.sms.transactional.webinar.post_missed.0', 'timing' => 'immediate', 'sort_order' => 430],
            ],
        ],
    ],
