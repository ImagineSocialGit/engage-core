    ...
    'models' => [
        ...
        'webinar' => [
            ...
            'aliases' => [
                ...
                'webinar_booking_url' => 'client-configured post-webinar booking URL',
        ...
        'campaign_enrollment' => [
            ...
            'notes' => 'Runtime status, progression, timing, and exit state are owned by the linked Messaging MessageChainEnrollment. Additional campaign-specific copy tokens should be supplied through payload/start_context and documented per campaign.',
        ],
