    ...
    'modules' => [
        ...
        'core' => [
            ...
            'settings' => [
                ...
                [
                    'key' => 'contact_maintenance',
                    'category' => 'people_access',
                    'label' => 'Contact maintenance',
                    'description' => 'Normalize contact names and phone numbers and review records that may be duplicates.',
        ...
        'inbound_messaging' => [
            ...
            'settings' => [
                ...
                [
                    'key' => 'inbound_message_repair',
                    'category' => 'communications',
                    'label' => 'Inbound message repair',
                    'description' => 'Reconnect older text replies to contacts and repair message correlation after contact identity cleanup.',
