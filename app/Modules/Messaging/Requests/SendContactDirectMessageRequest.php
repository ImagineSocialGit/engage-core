...
final class SendContactDirectMessageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return array_merge([
            ...
            'direct_message.reason' => ['required', 'string', Rule::enum(ContactDirectMessageReason::class)],
    ...
    public function reason(): ContactDirectMessageReason
    {
        return ContactDirectMessageReason::from(
            (string) $this->validated('direct_message.reason'),
        );
    }

    public function purpose(): string
    {
        return $this->reason()->purpose()->value;
    }
