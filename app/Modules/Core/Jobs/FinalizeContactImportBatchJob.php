...
class FinalizeContactImportBatchJob implements ShouldBeUniqueUntilProcessing, ShouldQueue
{
    use Dispatchable;
    ...
    {
        return 'contact-import-finalize:'.$this->contactImportBatchId;
    }

    public function handle(ContactImportBatchProcessor $processor): void
    {
        $processor->finalizeBatch($this->contactImportBatchId);
    }
