...
class PauseCampaignAutomationDefinition
{
    ...
    public function __construct(
        ...
        public readonly string $reason = 'flow_route_paused_campaign',
    ...
    public static function from(array $input): self
    {
        ...
        return new self(
            ...
            reason: self::nullableString($input['reason'] ?? null) ?? 'flow_route_paused_campaign',
            onNotEnrolled: $onNotEnrolled,
            skipPendingMessages: (bool) ($input['skip_pending_messages'] ?? true),
            meta: is_array($input['meta'] ?? null) ? $input['meta'] : [],
            invalidReason: match (true) {
                $campaignKey === null => 'pause_campaign_missing_campaign_key',
                ! in_array($onNotEnrolled, self::ON_NOT_ENROLLED_OPTIONS, true) => 'pause_campaign_invalid_on_not_enrolled',
                default => null,
            },
        );
    }
