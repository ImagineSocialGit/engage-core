...
class CancelCampaignFamilyAutomationDefinition
{
    ...
    public function __construct(
        ...
        public readonly string $reason = 'flow_route_cancelled_campaign_family',
    ...
    public static function from(array $input): self
    {
        ...
        return new self(
            familyKey: $familyKey,
            reason: self::nullableString($input['reason'] ?? null) ?? 'flow_route_cancelled_campaign_family',
            onNotEnrolled: $onNotEnrolled,
            skipPendingMessages: (bool) ($input['skip_pending_messages'] ?? true),
            meta: is_array($input['meta'] ?? null) ? $input['meta'] : [],
            invalidReason: match (true) {
                $familyKey === null => 'cancel_campaign_family_missing_family_key',
                ! in_array($onNotEnrolled, self::ON_NOT_ENROLLED_OPTIONS, true) => 'cancel_campaign_family_invalid_on_not_enrolled',
                default => null,
            },
        );
    }
